...
import fetchMembers from '@/Fetcher/OireachtasAPI/members';
...
export default function Home() {
	...
	// console.log(members);
	pdfParser(
		'https://data.oireachtas.ie/ie/oireachtas/members/registerOfMembersInterests/dail/2023/2023-02-24_supplement-to-register-of-members-interests-2021-dail_en.pdf'
	);
	return (
		<>
			<Head>
