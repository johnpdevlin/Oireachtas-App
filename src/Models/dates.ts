...
export type OirDate = `${DailYear}-${ValidMonthStr}-${ValidDayStr}`;
export type ValidDayStr = `${'0' | '1' | '2' | '3'}${
	| '1'
	| '2'
	| '3'
	| '4'
